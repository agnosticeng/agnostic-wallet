<script lang="ts">
	...
	function isValidThemePreference(raw: unknown): raw is 'light' | 'dark' | 'system' {
		return typeof raw === 'string' && (raw === 'light' || raw === 'dark' || raw === 'system');
	}
	...
	function handleThemeChange(
		...
		if (upcoming_preference === 'system') $theme.current = getCurrentSystemPreference();
